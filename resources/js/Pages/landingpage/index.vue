        ...
        <section id="home"
            ...
            <div class="max-w-4xl mx-auto px-4 text-center relative z-10">
                ...
                <h1
                    ...
                    <span class="text-2xl md:text-3xl lg:text-4xl font-bold text-slate-500">Lepas Kunci & Dengan
                        Sopir</span>
                </h1>

                <p class="text-base md:text-lg text-slate-500 mb-10 max-w-2xl mx-auto leading-relaxed">
                    Armada terbaru <strong class="text-slate-700">Avanza, Innova, Hiace, Fortuner, Alphard</strong> siap
                    mengantar perjalanan Anda.
